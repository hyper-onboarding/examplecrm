        ...
        node: {
          ...
          fieldsList: [
            ...
            },
            {
              ...
              relationDefinition: null,
              label: "Secret",
              description: "Optional secret used to compute the HMAC signature for webhook payloads. This secret is shared between ExampleCRM and the webhook consumer to authenticate webhook requests."
            },
            {
              __typename: "Field",
