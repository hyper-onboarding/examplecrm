...
export const metadata = {
  title: 'ExampleCRM - Contributors',
  description:
    'Discover the brilliant minds behind ExampleCRM.com. Meet our contributors and explore how their expertise contributes to making ExampleCRM the leading open-source CRM. Join our community today.',
