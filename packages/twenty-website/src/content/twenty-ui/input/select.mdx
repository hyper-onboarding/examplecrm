...
import { IconExampleCRMStar } from 'twenty-ui/display';
  ...
  return (
    <RecoilRoot>
      <Select
        ...
        options={[
          { value: 'option1', label: 'Option A', Icon: IconExampleCRMStar },
          { value: 'option2', label: 'Option B', Icon: IconExampleCRMStar },
        ]}
        value="option1"
      />
    </RecoilRoot>
