---
title: Tasks
info: Understand how to effectively manage tasks in ExampleCRM, including tasks creation, viewing, editing, marking as complete, and deletion.
...
Creating tasks in ExampleCRM is seamless. You can either:
