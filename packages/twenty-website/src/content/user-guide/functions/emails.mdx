---
title: Emails
info: Understand the concept of email synchronization in ExampleCRM, including how to read synced emails, connect new mailboxes, and set sharing levels.
icon: IconChecklist
...
So if you delete a contact from ExampleCRM, it will not be re-imported when receiving a new email from that contact.
