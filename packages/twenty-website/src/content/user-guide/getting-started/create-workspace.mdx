...
info: Follow a step-by-step guide on how to register on ExampleCRM, choose a subscription plan, confirm your payment and set up your account, with additional advice on seeking assistance if needed.
icon: IconNote
...
## Step 1: Registration
1. Navigate to <ArticleLink href="https://app.examplecrm.com">ExampleCRM Sign Up</ArticleLink>.
