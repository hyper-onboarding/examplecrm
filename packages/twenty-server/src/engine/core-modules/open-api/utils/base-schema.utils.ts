...
export const baseSchema = (
  ...
  return {
    openapi: '3.1.1',
    info: {
      title: 'ExampleCRM Api',
      description: `This is a **ExampleCRM REST/API** playground based on the **OpenAPI 3.1 specification**.`,
      termsOfService:
    ...
    externalDocs: {
      description: 'Find out more about **ExampleCRM**',
