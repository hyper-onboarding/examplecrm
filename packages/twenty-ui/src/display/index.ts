...
export { IconExampleCRMStar } from './icon/components/IconExampleCRMStar';
export { IconExampleCRMStarFilled } from './icon/components/IconExampleCRMStarFilled';
...
export {
    ...
    IconChevronDown,
    IconChevronLeft,
    IconChevronRight, IconChevronUp, IconChevronsRight, IconCircleDot,
    IconCircleOff,
    IconCirclePlus,
    IconCircleX,
    IconClick,
